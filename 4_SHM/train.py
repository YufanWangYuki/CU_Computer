...
def get_args():
    ...
    parser.add_argument('--trainList', default='./data/train.txt', help='train img ID')
    ...
    parser.add_argument('--nThreads', type=int, default=1, help='number of threads for data loading')
...
def main():
    ...
    # pdb.set_trace()
    train_data = getattr(dataset, args.trainData)(root_dir=args.dataDir,imglist=args.trainList,patch_size=args.patch_size)
